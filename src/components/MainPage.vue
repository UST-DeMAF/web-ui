    ...
    <v-main>
      <v-tabs-window class="h-100" v-model="selectedTab">
        <v-tabs-window-item class="h-100" value="Start">
          <StartTab :_lastTransformations="this.lastTransformations" :_selectedTab="this.selectedTab" :_session="this.session" :_viewTabs="this.viewTabs" @openTrans="openTrans" @removeTrans="removeTrans"/>
        </v-tabs-window-item>
